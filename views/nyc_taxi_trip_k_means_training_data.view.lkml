include: "/explores/nyc_taxi_trip_field_suggestions.explore"

view: nyc_taxi_trip_k_means_training_data {
    ...
    parameter: select_item_id {
      ...
      type: unquoted
      suggest_explore: nyc_taxi_trip_field_suggestions
      suggest_dimension: nyc_taxi_trip_field_suggestions.column_name
    }
